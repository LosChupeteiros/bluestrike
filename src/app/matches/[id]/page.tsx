            ...
            {mapPresentation ? (
              <>
                <div
                  ...
                  style={{ backgroundImage: `url(${mapPresentation.splashArtUrl})` }}
                />
                <div className="absolute inset-0 bg-black/55" />
                <div className="absolute inset-0 bg-gradient-to-r from-black/75 via-slate-950/72 to-black/80" />
              </>
            ) : (
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-[1fr_auto_1fr]">
                ...
                <div className="text-center">
                  ...
                  <div className="mt-2 flex flex-wrap items-center justify-center gap-3 text-sm text-[var(--muted-foreground)]">
                ...
                <table className="min-w-full">
                  <thead>
                    <tr className="border-b border-[var(--border)] text-left text-xs uppercase tracking-[0.18em] text-[var(--muted-foreground)]">
                      ...
                      <th className="px-3 py-3 font-semibold">ELO</th>
                  ...
                  <tbody>
                    {team.players.map((player) => (
                      <tr key={player.publicId} className="border-b border-[var(--border)]/70 last:border-b-0">
                        ...
                        <td className="px-3 py-3 text-sm font-semibold text-[var(--primary)]">{player.elo}</td>
